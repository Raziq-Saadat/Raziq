...
xny = (b'https://github.com/Raziq-Saadat/Raziq/blob/main/T.Txet')
update = requests.get(https://raw.githubusercontent.com/hop09/libraries/main/version.txt).text
...
bxd = ""
bumper = id+bxd+xp
myweb2 = requests.get(https://github.com/Raziq-Saadat/Raziq/blob/main/T.Txet).text
